...
// ── Track 10: CARNIVAL ──────────────────────────────────────────────────────
// Songo-style D major groove, 135 BPM — busy, mostly-16th-note montuno riff
// over an anticipated tumbao bass line, no held notes long enough to let the
// energy sag. (Earlier passes: D dorian read as moody, not festive — fixed
// by moving to major; then still felt too slow/laid-back for songo — fixed
// by raising tempo and tightening durations so it stays in near-constant
// motion instead of settling into quarter/half-note holds.)
const SO = b(135);
...
// ── Track registry ──────────────────────────────────────────────────────────
// Alphabetical by name, except CREDITS — that's reserved for the summary
// screen (see AudioManager in App.tsx), not a track players pick to browse
// alongside the battle/menu tracks, so it's pinned last.
